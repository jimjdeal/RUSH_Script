...
// ------------------------------------------------------------------ //
	...
	if (VAUS_confirmBool == true) then {
		...
		if (VAUS_confirmedConfirm == 1) then {
			...
			[VAU_control, VAUS_group, VAUS_camo] execVM voiceActivatedUnitSpawner\VAUS_create_Units.sqf;
			// if (VAUS_control == 1) then {
			// 	[VAUS_group, VAUS_camo] execVM voiceActivatedUnitSpawner\VAUS_create_DC_Units.sqf;
			// };
			// if (VAUS_control == 2) then {
			// 	[VAUS_group, VAUS_camo] execVM voiceActivatedUnitSpawner\VAUS_create_HC_Units.sqf;
			// };
		};
